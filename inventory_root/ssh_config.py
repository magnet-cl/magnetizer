...
# Obtained from https://github.com/ansible/ansible/blob/stable-2.9/contrib/inventory/ssh_config.py
...
_ssh_to_ansible = [('hostname', 'ansible_ssh_host'),
...
def print_list():
    ...
    for alias, attributes in cfg.items():
        ...
        meta['hostvars'][alias]['ansible_ssh_user'] = 'root'
